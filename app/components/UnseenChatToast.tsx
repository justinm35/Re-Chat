...
const UnseenChatToast: FC<UnseenChatToastProps> = ({t, sessionId, senderId, senderImg, senderName, senderMessage}) => {
  return <div className={cn('max-w-md w-full bg-white shadow-lg rounded-lg pointer-event-auto flex ring-1 ring-black ring-opacity-5', 
  {
    'animate-center' : t.visible,
